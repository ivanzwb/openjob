...
import { decideCapabilityNavVisible, type CapabilityNavState } from '@core/hostUi';
import { capabilityMode } from '@core/plugins/clientView';
 ...
 * `@core/hostUi`，这里只负责取数与「上一次结论」的落盘。
 *
