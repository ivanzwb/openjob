...
import { jdSummaryForPrompt } from '@core/prompts/candidateContext';
import {
...
import { resumeExperienceBlock, resumeFactsBlockForSelfIntro } from '@core/resume/experienceTimeline';
