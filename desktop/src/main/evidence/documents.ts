...
import { pickVariantForCampaign } from '@core/resume/campaignBinding';
import type { CandidateDocument, JobContextDocument } from '@core/evidence';
...
export function loadCandidateDocuments(
  ...
  if (campaign.job_target_id && campaign.resume_id) {
    ...
    // 「哪份派生版算数」与 prompt 装配共用 @core/resume/campaignBinding，
    // 否则证据会从一份、答案会从另一份取
