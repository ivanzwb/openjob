...
const FROZEN_OFFENDERS: Readonly<Record<string, readonly (readonly [string, number])[]>> = {
  // 判据一 · 软件工程
  repoNoun: [
    ['core/src/entities.ts', 4],
    ['core/src/enums.ts', 1],
    ['core/src/ipc.ts', 26],
    ['core/src/planner/__fixtures__/prePluginPlan.ts', 10],
    ['core/src/planner/contributions.ts', 11],
    ['core/src/plugins/__fixtures__/phase0Campaign.ts', 7],
    ['core/src/plugins/__fixtures__/phase1Campaign.ts', 1],
    ['core/src/plugins/capabilityEntries.ts', 1],
    ['core/src/plugins/package/contract.ts', 1],
    ['core/src/plugins/pluginRuntime/host.ts', 1],
    ['core/src/prompts/registry.ts', 9],
    ['core/src/prompts/repo.ts', 7],
    ['core/src/repo/snapshotDiff.ts', 3],
    ['core/src/sync.ts', 2],
    ['desktop/src/main/annotation/index.ts', 3],
    ['desktop/src/main/db/schema.ts', 17],
    ['desktop/src/main/ipc/index.ts', 13],
    ['desktop/src/main/llm/index.ts', 50],
    ['desktop/src/main/llm/toolPolicy.ts', 3],
    ['desktop/src/main/paths.ts', 3],
    ['desktop/src/main/plan/edit.ts', 3],
    ['desktop/src/main/plan/schedule.ts', 49],
    ['desktop/src/main/plugins/inventory.ts', 1],
    ['desktop/src/main/plugins/package/trustedKeys.ts', 1],
    ['desktop/src/main/plugins/permissionGateway.ts', 1],
    ['desktop/src/main/repo/codeRefs.ts', 6],
    ['desktop/src/main/repo/files.ts', 42],
    ['desktop/src/main/repo/reanchorRefs.ts', 7],
    ['desktop/src/main/repo/repository.ts', 86],
    ['desktop/src/main/repo/snapshot.ts', 28],
    ['desktop/src/main/repo/symbols.ts', 6],
    ['desktop/src/main/repo/tools.ts', 16],
    ['desktop/src/main/repo/treeSitter.ts', 1],
    ['desktop/src/main/speech/index.ts', 7],
    ['desktop/src/main/sync/apply.ts', 1],
    ['desktop/src/main/sync/deviceLocalDefaults.ts', 1],
    ['desktop/src/main/sync/fkDiagnostics.ts', 1],
    ...
    ['desktop/src/renderer/src/components/TaskCard.tsx', 1],
    ['desktop/src/renderer/src/components/TaskStudyPanel.tsx', 4],
    ['desktop/src/renderer/src/ipc/useStream.ts', 2],
    ['desktop/src/renderer/src/pluginRuntimes/runtime.ts', 5],
    ['mobile/src/components/ReadCodePanel.tsx', 11],
    ['mobile/src/components/RepoQaPanel.tsx', 19],
    ['mobile/src/components/StudyPlanCalendarPopover.tsx', 1],
    ['mobile/src/context/AppContext.tsx', 7],
    ['mobile/src/data/mutations.ts', 24],
    ['mobile/src/data/planLocal.ts', 16],
    ['mobile/src/data/queries.ts', 23],
    ['mobile/src/data/repoFiles.ts', 23],
    ['mobile/src/data/repoLocal.ts', 8],
    ['mobile/src/data/repoQaThread.ts', 5],
    ['mobile/src/data/repoTools.ts', 13],
    ['mobile/src/data/rolePackLocal.ts', 1],
    ['mobile/src/db/index.ts', 26],
    ['mobile/src/db/migrate.ts', 1],
    ['mobile/src/db/migrations/bundle.ts', 15],
    ['mobile/src/db/schemaEnsure.ts', 8],
    ...
    ['mobile/src/sync/repoFileStorage.ts', 3],
  ],
  codeRefNoun: [
    ['core/src/enums.ts', 2],
    ['core/src/ipc.ts', 2],
    ...
    ['desktop/src/main/ipc/index.ts', 1],
    ['desktop/src/main/repo/codeRefs.ts', 7],
    ['desktop/src/main/repo/index.ts', 1],
    ['desktop/src/main/repo/reanchorRefs.ts', 6],
    ['desktop/src/main/repo/repository.ts', 7],
    ['desktop/src/main/speech/index.ts', 3],
    ['desktop/src/main/sync/rpc.ts', 2],
    ['desktop/src/main/sync/tables.ts', 1],
    ['desktop/src/renderer/src/components/AnnotationDigest.tsx', 3],
    ['desktop/src/renderer/src/components/CodePanel.tsx', 5],
    ['mobile/src/data/queries.ts', 1],
  ],
  designCaseNoun: [
    ['core/src/design/prompts.ts', 1],
    ['desktop/src/main/db/schema.ts', 1],
    ['desktop/src/main/design/index.ts', 15],
    ['desktop/src/main/sync/tables.ts', 1],
    ['desktop/src/renderer/src/pages/DesignPractice.tsx', 30],
    ['mobile/src/data/designLocal.ts', 4],
    ['mobile/src/screens/DesignScreen.tsx', 34],
  ],
  tabularDataset: [['core/src/case/dataset.ts', 2]],
  rolePlayNoun: [
    ['desktop/src/main/ipc/index.ts', 1],
    ['desktop/src/main/plugins/interactionRuntime.ts', 2],
    ['desktop/src/main/plugins/rolePlaySession.ts', 2],
    ['desktop/src/renderer/src/pages/DesignPractice.tsx', 3],
  ],
  readCodeNoun: [
    ['core/src/enums.ts', 1],
    ['core/src/planner/__fixtures__/prePluginPlan.ts', 1],
    ['core/src/planner/contributions.ts', 4],
    ['core/src/plugins/__fixtures__/phase0Campaign.ts', 3],
    ['desktop/src/renderer/src/components/TaskCard.tsx', 3],
    ['desktop/src/renderer/src/components/TaskStudyPanel.tsx', 1],
    ['mobile/src/components/ReadCodePanel.tsx', 1],
  ],
  capabilityIdLiteral: [
    ['desktop/src/main/llm/index.ts', 1],
    ['desktop/src/main/repo/repository.ts', 2],
    ['desktop/src/main/repo/tools.ts', 1],
    ['mobile/src/llm/agentChat.ts', 1],
  ],
  rolePackIdLiteral: [
    ['core/src/planner/contributions.ts', 1],
  ...
  prePluginDefaultRolePack: [
    ['core/src/planner/contributions.ts', 1],
    ['desktop/src/main/plan/schedule.ts', 2],
    ['desktop/src/main/plugins/bootstrap.ts', 2],
    ['desktop/src/main/plugins/install.ts', 2],
  ],
  ...
  designChannel: [
    ['core/src/ipc.ts', 10],
    ['desktop/src/main/ipc/index.ts', 5],
    ['desktop/src/main/sync/rpc.ts', 10],
    ['desktop/src/renderer/src/pages/DesignPractice.tsx', 8],
  ],
  rolePlayChannel: [
    ['core/src/ipc.ts', 6],
    ['desktop/src/main/ipc/index.ts', 3],
    ['desktop/src/renderer/src/components/RolePlayRunner.tsx', 3],
  ],
  annotationListForRepo: [
    ['core/src/ipc.ts', 2],
    ['desktop/src/main/ipc/index.ts', 1],
    ['desktop/src/main/sync/rpc.ts', 1],
    ['desktop/src/renderer/src/components/RepoWorkspace.tsx', 1],
  ],
  sweTableName: [
    ['core/src/ipc.ts', 1],
    ['core/src/plugins/__fixtures__/phase1Campaign.ts', 1],
    ...
    ['desktop/src/main/plugins/inventory.ts', 1],
    ['desktop/src/main/repo/codeRefs.ts', 1],
    ['desktop/src/main/repo/files.ts', 1],
    ['desktop/src/main/repo/reanchorRefs.ts', 1],
    ['desktop/src/main/repo/repository.ts', 1],
    ['desktop/src/main/repo/snapshot.ts', 1],
    ['desktop/src/main/sync/apply.ts', 1],
    ['desktop/src/main/sync/deviceLocalDefaults.ts', 1],
    ['desktop/src/main/sync/fkDiagnostics.ts', 1],
    ['desktop/src/main/sync/labels.ts', 1],
    ['desktop/src/renderer/src/components/CodePanel.tsx', 1],
    ['mobile/src/data/repoFiles.ts', 7],
    ['mobile/src/db/index.ts', 2],
    ['mobile/src/db/migrate.ts', 1],
    ['mobile/src/db/migrations/bundle.ts', 5],
    ['mobile/src/db/schemaEnsure.ts', 3],
    ['mobile/src/sync/repoFilePartition.ts', 3],
    ['mobile/src/sync/repoFileStorage.ts', 2],
  ],
  pmTableName: [
  ...
  techStackColumn: [
    ...
    ['mobile/src/data/designLocal.ts', 3],
  ...
  repoStatusesConstant: [['core/src/enums.ts', 2]],
  roleEnumValue: [
    ['core/src/design/prompts.ts', 1],
    ...
    ['core/src/ipc.ts', 1],
    ['core/src/planner/__fixtures__/prePluginPlan.ts', 1],
    ['core/src/planner/contributions.ts', 2],
    ['core/src/plugins/__fixtures__/phase0Campaign.ts', 2],
    ['core/src/plugins/examForms.ts', 1],
    ['desktop/src/main/annotation/index.ts', 1],
    ['desktop/src/main/design/index.ts', 2],
    ['desktop/src/main/diagnosis/tree.ts', 1],
    ['desktop/src/main/llm/index.ts', 1],
    ['desktop/src/main/practice/history.ts', 4],
    ['desktop/src/main/speech/index.ts', 5],
    ['desktop/src/renderer/src/App.tsx', 4],
    ['desktop/src/renderer/src/components/AnnotationDigest.tsx', 1],
    ['desktop/src/renderer/src/components/CodePanel.tsx', 1],
    ['desktop/src/renderer/src/components/RepoWorkspace.tsx', 1],
    ['desktop/src/renderer/src/components/TaskCard.tsx', 1],
    ['desktop/src/renderer/src/components/TaskStudyPanel.tsx', 1],
    ['mobile/src/data/designLocal.ts', 3],
    ['mobile/src/data/mutations.ts', 3],
...
describe('基础包岗位中立（§6 三条判据）', () => {
  it('扫到了三个应用源码根，否则下面三条判据都是空跑', () => {
    ...
    expect(files).toContain('mobile/src/screens/ReposScreen.tsx');
