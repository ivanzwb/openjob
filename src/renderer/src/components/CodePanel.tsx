    ...
    <>
      ...
      <div ref={bodyRef} className="min-h-0 flex-1 overflow-auto p-3">
        ...
        {!loading && !error && html && (
          ...
          <div
            className="shiki-host font-mono text-[11px] leading-[14px]"
            data-code-panel=""
            data-line-numbers=""
        ...
        {!loading && !error && !html && meta && (
          <pre className="font-mono text-[11px] leading-[14px] text-[var(--color-fg)]">
            {content.split('\n').map((line, index) => (
              <span key={meta.startLine + index} className="block min-h-[14px]">
