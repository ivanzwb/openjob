...
import { EvidenceRejectedError, locateInDocument } from '@shared/evidence';
import type { EvidenceProposal } from '@shared/evidence';
import {
  COMPANY_INTEL_MD,
  JD_ONLY_PHRASES,
  JD_RAW,
  RESUME_MD,
  SELF_REPORT_MD,
} from '@shared/evidence/__fixtures__/candidateDocuments';
