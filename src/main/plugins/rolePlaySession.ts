...
import { composePrompt, type ComposedPrompt } from '@shared/prompts/composer';
import {
...
} from '@shared/plugins/builtin/rolePlay';
import { buildInteractionHostView } from '@shared/plugins/interactions/hostView';
import type { PluginPermission } from '@shared/plugins/permissions';
import type { InterviewFormatDefinition, RolePack } from '@shared/plugins/types';
import type {
  EndRolePlayRequest,
  RolePlaySessionView,
  RolePlayTurnView,
...
} from '@shared/plugins/interactions/sessionView';
